# -*- coding: utf-8 -*-
"""
Created on Thu Jan  5 18:06:19 2017
...
train_path_1 = PATH + "original_data/"
train_path_2 = PATH + "PS4_data1/"
train_path_3 = PATH + "PS4_data2/"
train_path_4 = PATH + "PS4_data3/"
train_path_5 = PATH + "PS4_data5/"
train_path_6 = PATH + "PS4_data6/"
train_path_8 = PATH + "PS4_data8/"
train_path_9 = PATH + "PS4_data9/"
train_path_10 = PATH + "PS4_data7/"
...
# Do the binning for avoiding extremely imbalanced cases.
n_bins = 256
n_labels = n_bins
min_bin = -1.0
max_bin = 1.0
...
# Crop!
X, y, s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
histo = generateHistogram(y, n_labels)
plotHistogram(histo, binning_array)
del train_data, steering
# Load next batch.
train_data, steering, _ = loadData(train_path_2)
new_X, new_y, new_s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
del train_data, steering
X = np.concatenate((X, new_X))
y = np.concatenate((y, new_y))
s = np.concatenate((s, new_s))
del new_X, new_y, new_s
# Load next batch.
train_data, steering, _ = loadData(train_path_3)
new_X, new_y, new_s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
del train_data, steering
X = np.concatenate((X, new_X))
y = np.concatenate((y, new_y))
...
del new_X, new_y, new_s
# Load next batch.
train_data, steering, data_log = loadData(train_path_4)
new_X, new_y, new_s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
del train_data, steering
X = np.concatenate((X, new_X))
y = np.concatenate((y, new_y))
...
del new_X, new_y, new_s
# Load next batch.
train_data, steering, _ = loadData(train_path_5)
new_X, new_y, new_s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
del train_data, steering
X = np.concatenate((X, new_X))
y = np.concatenate((y, new_y))
...
del new_X, new_y, new_s
# Load next batch.
train_data, steering, _ = loadData(train_path_6)
new_X, new_y, new_s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
del train_data, steering
X = np.concatenate((X, new_X))
y = np.concatenate((y, new_y))
...
del new_X, new_y, new_s
# Load new batch.
train_data, steering, _ = loadData(train_path_8)
new_X, new_y, new_s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
del train_data, steering
X = np.concatenate((X, new_X))
y = np.concatenate((y, new_y))
...
del new_X, new_y, new_s
# Load new batch.
train_data, steering, _ = loadData(train_path_9)
new_X, new_y, new_s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
del train_data, steering
X = np.concatenate((X, new_X))
y = np.concatenate((y, new_y))
...
del new_X, new_y, new_s
# Load new batch.
train_data, steering, _ = loadData(train_path_10)
new_X, new_y, new_s = cropMajority(train_data, steering, n_labels, binning_array, 3500)
del train_data, steering
X = np.concatenate((X, new_X))
y = np.concatenate((y, new_y))
s = np.concatenate((s, new_s))
del new_X, new_y, new_s
# Show how the cases are distributed.
histo = generateHistogram(y, n_labels)
plotHistogram(histo, binning_array)
# Store the data.
paths=[]
...
del X, y, s, paths, histo, data_log, df, y_train    
